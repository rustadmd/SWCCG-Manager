 ...
 *
 */
public class CollectionListComboBoxModel extends AbstractListModel<Collection> implements
ComboBoxModel<Collection>  {
	...
	/**
	 * Will update the list of collections from the database
	 */
	...
	public Collection getElementAt(int index) {
		Collection objectAtIndex = list.getElementAt(index);
	...
	@Override
	public Collection getSelectedItem() {
		int minSelectionIndex = listSelectionModel.getMinSelectionIndex();
		if (minSelectionIndex < 0) {
			return null;
		}
		Collection elementAt = getElementAt(minSelectionIndex);
		return elementAt;
	}
